            ...
            <div className="mb-6 text-center">
              ...
              <div className="mx-auto mt-3 max-w-sm rounded-lg border border-amber-900/40 bg-amber-950/20 px-3 py-2">
                <p className="text-[11px] leading-relaxed text-amber-200/70">
                  <span className="font-semibold">AI Disclaimer:</span> Responses are generated by AI and may contain errors, outdated information, or inaccuracies. Always verify critical information against primary sources.
                </p>
              </div>
            </div>
      ...
      <div className="border-t border-zinc-800 bg-[#0a0a0a] p-3">
        {messages.length > 0 && (
          <div className="mb-2 text-center text-[10px] text-zinc-600">
            AI-generated — may be inaccurate. Verify against primary sources.
          </div>
        )}
